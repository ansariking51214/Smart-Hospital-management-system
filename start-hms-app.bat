...
start "HMS Backend Server" cmd /k "cd /d %~dp0backend && node src/server.js"

REM 2. Start Frontend in separate window
echo [2/3] Starting Frontend Vite Server (Port 5173)...
start "HMS Frontend Server" cmd /k "cd /d %~dp0frontend && node ./node_modules/vite/bin/vite.js --port 5173 --host"
